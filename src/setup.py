...
BOT_DESCRIPTION = (
    ...
    # Ссылку словом описание не умеет, а @адрес в конце владелец убрал как некрасивый
    # (16.09.2026): ссылки на канал — в приветствии сразу после «Начать» (service.MENU).
    "Всё бесплатно — достаточно подписаться на канал."
)
