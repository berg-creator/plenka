...
# Первая строка — пустой символ Брайля (U+2800): отступ от заголовка Telegram
# «Что может делать этот бот?». Перевод строки в начале API срезает.
BOT_DESCRIPTION = (
    "\u2800\n"
    "Бот канала ПЛЁНКА — тёмный звук: фонк, эмо-рэп, дрейн.\n\n"
