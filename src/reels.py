...
# всё равно не услышал: громкость бита держит 808, а её телефон не играет. Теперь
# бит на 1 дБ громче голоса по R128 (в СКЛЕЙКЕ вровень, VOCAL_OVER_BEAT = 0): голос ведёт
# за счёт места в своих полосах, а не за счёт тихого бита.
BEAT_LUFS = -10.0
