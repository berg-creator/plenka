...
SOURCES = {"yt": "YouTube", "tt": "TikTok", "vk": "ВКонтакте", "chat": "чаты артистов", "pin": "закреп канала",
           ...
           "skleyka_xz": "СКЛЕЙКА, платно: XzWorkshop",
           "skleyka_shkola": "СКЛЕЙКА, платно: Школа Битмейкинга",
           "skleyka_musicheads": "СКЛЕЙКА, платно: Школа Musicheads",
           "skleyka_blog": "СКЛЕЙКА, платно: Блог о продаже битов",
